...
const About = () => {
    return (
        <div id='about' className='2xl:mx-64 mx-5 lg:flex items-center gap-10 justify-between xl:mx-32'>

            <div className='hidden lg:block ninja24'>
            ...
            <div className='lg:hidden bouncing-image ninja24'>
                <img className='rounded-lg' src={aboutimage} alt="" />
            </div>
